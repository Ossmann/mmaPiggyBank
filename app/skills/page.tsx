      ...
      <div className='p-20'>
        <div className='relative'>
          ...
          <div className='relative p-20'>
            ...
            <p>In the present section I will describe the technical skills I was able to hone through my work integrated learning placement. For each technical skill I will apply the CARL (Context, Action, Result, Learning) reflective framework to showcase what I have learned. I am happy I had the opportunity to develop new skills in a variety of areas such as appl`&#39;`s VisionOS framework, the web-development framework nextjs and Generative Artificial Intelligence development through my WIL Placement.</p>
