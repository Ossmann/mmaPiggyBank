      ...
      <div className='overflow-x-hidden overflow-y-hidden'>
        ...
        <div className="scroll-container">
          {fightCards.map((fightCard) => (
            <div
              className={`scroll-item ${selectedFightCardId === fightCard.fight_card_id ? 'selected' : ''} ${fightCard.fight_card_id === 12 ? 'current' : ''}`} // Apply the 'current' class if fight_card_id is 7
